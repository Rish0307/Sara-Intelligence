...
export default function DashboardView({
  ...
  return (
    <div className="flex-1 p-4 bg-white/2 grid grid-cols-12 gap-4 overflow-hidden relative animate-in fade-in zoom-in duration-300 w-full" style={{height: '100%'}}>
      <div className="hidden lg:flex col-span-3 flex-col gap-4 min-h-0 z-40">
        <div
        ...
        <div className={`${glassPanel} flex-1 min-h-0 p-4 flex flex-col gap-3`}>
      ...
      <div className="hidden lg:flex col-span-3 flex-col overflow-hidden min-h-0 z-40">
        <div className={`${glassPanel} min-h-0 flex-1 p-4 flex flex-col`}>
          ...
          <div ref={scrollRef} className="flex-1 min-h-0 overflow-y-auto space-y-3 pr-2 scrollbar-small pb-2">
