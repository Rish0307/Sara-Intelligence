...
ghost_coder
  root_path: string (required) — Directory path where files will be created
  structure: dict (required) — Dictionary mapping filenames to their code content

phantom_typer
  text: string (required) — The text to type
  target_app: string (optional) — The name of the window/app to focus before typing

screen_peeler
  # No parameters needed, captures and analyzes the full screen using multimodal vision.
