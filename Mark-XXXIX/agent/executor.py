...
def _call_tool(tool: str, parameters: dict, speak: Callable | None) -> str:
    ...
    elif tool == "ghost_coder":
        from actions.tool_ghost_coder import scaffold_workspace
        root_path = parameters.get("root_path", "")
        structure = parameters.get("structure", {})
        return scaffold_workspace(root_path=root_path, structure=structure)

    elif tool == "phantom_typer":
        from actions.tool_phantom_typer import type_global_text
        text = parameters.get("text", "")
        app = parameters.get("target_app")
        return type_global_text(text_to_type=text, target_app=app)

    elif tool == "screen_peeler":
        from actions.tool_screen_peeler import extract_text_from_screen
